...
public class CloudBackendAsync extends CloudBackend {
	 ...
	 */
	protected final Map<String, ContinuousQueryHandler> continuousQueries = new HashMap<String, ContinuousQueryHandler>();
	 ...
	 * 
	 * @param context
	 *            {@link Context} for getting Application for GCM registration
	 *            and SharedPreference. Null can be passed if you don't use
	 *            those features.
	 */
	 ...
	 * 
	 * @param ceList
	 *            a List of {@link CloudEntity}s that has kindName and id to
	...
	private void _list(CloudQuery query, CloudCallbackHandler<List<CloudEntity>> handler, Handler uiThreadHandler) {
	 ...
	 *            {@link CloudCallbackHandler} that handles the response.
	 */
	public void listByProperty(String kindName, String propertyName, Filter.Op operator, Object propertyValue,
	...
	protected class ContinuousQueryHandler {
		...
		public ContinuousQueryHandler(final CloudCallbackHandler<List<CloudEntity>> handler, final CloudQuery query,
